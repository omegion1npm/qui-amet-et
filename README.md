...
<a href="https://www.npmjs.com/package/@omegion1npm/qui-amet-et">
  <img alt="npm version" src="https://img.shields.io/npm/v/@omegion1npm/qui-amet-et.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@omegion1npm/qui-amet-et">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@omegion1npm/qui-amet-et.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @omegion1npm/qui-amet-et
# using pnpm
pnpm install -D @omegion1npm/qui-amet-et
# using yarn
yarn add --dev @omegion1npm/qui-amet-et
```
...
```ts
import { svgSpritemap } from '@omegion1npm/qui-amet-et';
